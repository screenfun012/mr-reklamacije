...
| --- | --- | --- | --- |
| 1 | Tri kolone tačnih širina (252 / flex / 250), panel samo u niti, ⓘ toggle | 2, 3 | ⏳ |
| 2 | Lista: DND, pretraga, KANALI + „+", NITI + „+", badge/MUTE/aktivno stanje, kind tačke | 2, 3, 6 | ⏳ |
...
| 13 | Nijedno dugme puna crvena ispuna | 2 | ⏳ *(brendbuk to ionako zabranjuje)* |
