...
function renderTab(): void {
  ...
  client.setQueryData(attachmentsListOptions(ClaimKind.Domace, CLAIM_ID).queryKey, {
    items: [makeAttachment()],
  })

  const node: ReactElement = (
    <QueryClientProvider client={client}>
      <DomaceClaimAttachmentsTab claimId={CLAIM_ID} />
    </QueryClientProvider>
  )
  render(node)
}

describe('DomaceClaimAttachmentsTab', () => {
  beforeEach(() => {
    setLocale('sr')
  })
