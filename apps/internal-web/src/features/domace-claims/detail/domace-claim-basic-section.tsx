...
function BasicReadOnly({ claim }: { claim: DomaceClaimDetail }): React.ReactElement {
  return (
    <>
      <dl className="grid gap-3 text-sm sm:grid-cols-2">
        <DetailItem label={m.domace_claims_create_field_mr_number()} value={claim.mrNumber} mono />
