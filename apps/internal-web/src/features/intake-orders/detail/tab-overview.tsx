...
export function TabOverview({ order }: { order: IntakeOrderDetail }): ReactElement {
  ...
  const facts = [
    ...
    },
    {
      ...
      value: m.intake_fact_fuel_value({ level: order.fuelLevel }),
      className: 'font-mono font-semibold',
    },
    {
      label: m.intake_fact_damages(),
      value: String(order.damages.length),
      className: cn(
        'font-mono font-semibold',
        order.damages.length > 0 ? 'text-mri-redh' : 'text-mri-grn',
      ),
    },
  ...
  return (
    <div className="@container">
      <div className="flex flex-col gap-[14px] @min-[900px]:flex-row @min-[900px]:items-stretch @min-[900px]:gap-4">
          ...
          <section className={cn(CARD, 'flex min-w-0 flex-1 gap-[18px] px-5 py-[18px]')}>
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-[11px]">
              ...
              {order.damages.length === 0 ? (
                <p className="text-[13.5px] italic text-mri-text2">{m.intake_detail_no_damage()}</p>
              ) : null}
        ...
        <div className="flex flex-col gap-[14px] @min-[900px]:w-[320px] @min-[900px]:flex-none">
