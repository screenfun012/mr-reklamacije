...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      fieldControlClassName,
      'justify-between gap-2 px-3 py-2 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        fieldPopoverContentClassName,
        'max-h-[min(var(--radix-select-content-available-height),24rem)] min-w-[var(--radix-select-trigger-width)] overflow-y-auto overflow-x-hidden',
        position === 'popper' &&
